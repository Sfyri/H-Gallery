...
class MobileLinkService:
    ...
    def authorize(self, *, device_id: str, token: str, touch: bool = False) -> dict[str, Any]:
        """Valida una sessione M6 senza esporre il token al livello M7."""
        with self._lock:
            ...
            return {
                "device_id": device_id,
                "name": str(data.get("name", "Android")),
            }
